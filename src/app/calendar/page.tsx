        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          <Card className="bg-gradient-to-r from-blue-500 to-blue-600 text-white">
            <CardContent className="p-4 md:p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-blue-100 text-xs md:text-sm">Toplam Süre</p>
          ...
          <Card className="bg-gradient-to-r from-purple-500 to-purple-600 text-white">
            <CardContent className="p-4 md:p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-purple-100 text-xs md:text-sm">Günlük Ortalama</p>
                  <p className="text-lg md:text-2xl font-bold">
                    {formatDuration(data.statistics.avgDailyMinutes)}
                  </p>
                  <p className="text-purple-100 text-xs">aktif günlerde</p>
                </div>
